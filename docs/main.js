...
class PetComponent {
    ...
    addPet() {
        if (this.editIndex === null) {
            ...
            this.pets.push(Object.assign({}, this.newPet));
        }
        else {
